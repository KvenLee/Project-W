...
namespace ProtoBuf.Meta
{
    ...
    public class MetaType : ISerializerProxy
    {
        ...
        private CreateInstance factory;
        /// <summary>
        /// Designate a factory-method to use to create instances of this type
        /// </summary>
        public MetaType SetFactory(CreateInstance factory)
        {
        ...
        internal MetaType(RuntimeTypeModel model, Type type, CreateInstance factory)
        {
            this.factory = factory;
