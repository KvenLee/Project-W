...
////////////////////////////////////////
    ...
    [UnityEditor.MenuItem("GameObject/Create Other/Cover2D")]
    public static void CreateCover2D()
    {
        //if(FindObjectOfType(typeof(Cover2D)) == null)
        {
            var newNav = new GameObject("@Cover2D").AddComponent<Cover2D>();
            UnityEditor.Selection.activeObject = newNav;
        }
    }
