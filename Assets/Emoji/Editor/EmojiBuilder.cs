...
public class EmojiBuilder
{
    ...
    public static void CreateEmojiText()
    {
        ...
        EmojiText emoji = go.AddComponent<EmojiText>();
        RectTransform rt = go.transform as RectTransform;
        rt.localScale = Vector3.one;
        rt.localPosition = Vector3.zero;
        rt.sizeDelta = new Vector3(100f, 100f);
        emoji.material = AssetDatabase.LoadAssetAtPath<Material>("Assets/ResourcesEx/" + BundleBelong.material + "/uguiemoji.mat");
        EditorGUIUtility.PingObject(go);
    }

    [MenuItem("Custom/EmojiText/Build Emoji")]
...
//                     }
        ...
        string new_path = "Assets/ResourcesEx/" + BundleBelong.data + "/emoji.txt";
        File.Copy(OutputPath + "emoji.txt", new_path, true);

        AssetImporter ai = AssetImporter.GetAtPath(new_path.Replace("\\", "/")) as AssetImporter;
        ai.assetBundleName = BundleBelong.data;
